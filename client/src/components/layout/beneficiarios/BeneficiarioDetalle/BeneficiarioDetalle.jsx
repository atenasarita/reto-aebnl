...
function BeneficiarioDetalle({ beneficiario, onClose }) {
  ...
  const { tipo_sanguineo, contacto_nombre, contacto_telefono, contacto_parentesco } = datos_medicos
      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.modalHeader}>
          <div className={styles.tabs}>
            <span className={`${styles.tab} ${styles.active}`}>Datos generales</span>
            <span className={styles.tab}>Historial asociado</span>
            <span className={styles.tab}>Historial padres</span>
          </div>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.topSection}>
                ...
                <div className={styles.topInfo}>
                    ...
                    <span className={styles.fieldValue} style={{ fontSize: '11px' }}>
                        {CURP}
                    </span>
                    </div>
                </div>
